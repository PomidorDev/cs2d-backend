...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 28 2022 г., 13:14
...
--
-- Структура таблицы `cash_chat`
--

CREATE TABLE `cash_chat` (
  `id` int NOT NULL,
  `chat_hash` varchar(256) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

--
-- Дамп данных таблицы `cash_chat`
--

INSERT INTO `cash_chat` (`id`, `chat_hash`) VALUES
(1, '8108358c7d0921464412a9bfa9afc0a7');
...
--
-- Индексы таблицы `cash_chat`
--
ALTER TABLE `cash_chat`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `cash_chat`
--
ALTER TABLE `cash_chat`
